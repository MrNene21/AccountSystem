...
class AccountTypeControllerTest {
    ...
    public void getAll() throws Exception {
        ...
        when(fetchAccountTypeFlow.getAllAccountTypes()).thenReturn((List<AccountDto>) o);
    ...
    public void create() throws Exception {
        ...
        //when(createAccountTypeFlow.create(eq(o))).then(returnsFirstArg());
        MvcResult mvcResult =
                mockMvc.perform(post(ACCOUNT_TYPE_CONTROLLER_URL)
                        ...
                        .andReturn();
        //verify(createAccountTypeFlow, times(1)).create(eq((Boolean) o));
        assertEquals(expectedResponse,
                mvcResult.getResponse().getContentAsString());
    }
    @Test
    public void deleteAccountType() throws Exception {
        ...
        //when(modifyAccountTypeFlow.deleteAccountType(anyString())).thenReturn(accoun tType);
